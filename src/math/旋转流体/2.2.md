...
\\
= 2\mu \frac{\partial v_i}{\partial x_i} - \frac{2}{3}\mu\frac{\partial v_k}{\partial x_k} + \mu_\vartheta\frac{\partial v_k}{\partial x_k}
$$
...
\\[0.5em]
= \sum_{j}\mu \frac{\partial}{\partial x_j}\left(\frac{\partial v_i}{\partial x_j} + \frac{\partial v_j}{\partial x_i}\right) - \frac{2}{3}\mu\frac{\partial}{\partial x_i}\left(\frac{\partial v_k}{\partial x_k}\right) + \mu_\vartheta\frac{\partial}{\partial x_i}\left(\frac{\partial v_k}{\partial x_k}\right)
$$
...
\mathbf{f} = f_i =\sum_{j} \frac{\partial \tau_{ij}}{\partial x_j}
\\[0.5em]
= \mu\nabla^2v_i + \mu\frac{\partial}{\partial x_i}\left(\frac{\partial v_k}{\partial x_k}\right) - \frac{2}{3}\mu\frac{\partial}{\partial x_i}\left(\frac{\partial v_k}{\partial x_k}\right) + \mu_\vartheta\frac{\partial}{\partial x_i}\left(\frac{\partial v_k}{\partial x_k}\right)
\\[0.5em]
= \mu\nabla^2v_i + \left(\frac{1}{3}\mu + \mu_\vartheta\right)\frac{\partial}{\partial x_i}\left(\frac{\partial v_k}{\partial x_k}\right)
$$
