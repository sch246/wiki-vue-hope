...
$$
$$
=\frac{\partial v_x}{\partial x}+\frac{\partial v_y}{\partial y}+\frac{\partial v_z}{\partial z}=\text{div}\mathbf{v}
$$
...
$$
\frac{\partial f}{\partial x_k}\mathbf{e_k}=\frac{\partial f}{\partial x_1}\mathbf{e_1}+\frac{\partial f}{\partial x_2}\mathbf{e_2}+\frac{\partial f}{\partial x_3}\mathbf{e_3}
$$
$$
=\begin{bmatrix}
...
$$
\tau_{ij} = \mu \left(\frac{\partial v_i}{\partial x_i} + \frac{\partial v_i}{\partial x_i} - \frac{2}{3}\frac{\partial v_k}{\partial x_k}\right) + \mu_B\frac{\partial v_k}{\partial x_k}
\\
= 2\mu \frac{\partial v_i}{\partial x_i} - \frac{2}{3}\mu\frac{\partial v_k}{\partial x_k} + \mu_B\frac{\partial v_k}{\partial x_k}
$$
...
通常用 3x3 矩阵表示(在三维空间中)，每个元素代表应力在不同面和方向上的分量
...
$\tau_{ij}$ 是标量，表示 $i$ 法平面上 $j$ 正方向的力的大小
...
张量的矢量散度就是对张量矩阵的每一行(一个法平面上的矢量力)求散度，得到 3 个标量

它们组成的矢量代表体积微元受到的合力

$$
\mathbf{f} = f_i =\sum_{j} \frac{\partial \tau_{ij}}{\partial x_j}
\\[0.5em]
= \sum_{j}\mu \frac{\partial}{\partial x_j}\left(\frac{\partial v_i}{\partial x_j} + \frac{\partial v_j}{\partial x_i}\right) - \frac{2}{3}\mu\frac{\partial}{\partial x_i}\left(\frac{\partial v_k}{\partial x_k}\right) + \mu_B\frac{\partial}{\partial x_i}\left(\frac{\partial v_k}{\partial x_k}\right)
$$

其中第一项

$$
\sum_{j}\mu \frac{\partial}{\partial x_j}\left(\frac{\partial v_i}{\partial x_j} + \frac{\partial v_j}{\partial x_i}\right)
= \mu\nabla^2v_i + \sum_{j}\mu\frac{\partial}{\partial x_i}\left(\frac{\partial v_j}{\partial x_j}\right)
\\[0.5em]
= \mu\nabla^2v_i + \mu\frac{\partial}{\partial x_i}\left(\frac{\partial v_k}{\partial x_k}\right)
$$
...
\mathbf{f} = f_i =\sum_{j} \frac{\partial \tau_{ij}}{\partial x_j}
\\[0.5em]
= \mu\nabla^2v_i + \mu\frac{\partial}{\partial x_i}\left(\frac{\partial v_k}{\partial x_k}\right) - \frac{2}{3}\mu\frac{\partial}{\partial x_i}\left(\frac{\partial v_k}{\partial x_k}\right) + \mu_B\frac{\partial}{\partial x_i}\left(\frac{\partial v_k}{\partial x_k}\right)
\\[0.5em]
= \mu\nabla^2v_i + \left(\frac{1}{3}\mu + \mu_B\right)\frac{\partial}{\partial x_i}\left(\frac{\partial v_k}{\partial x_k}\right)
$$
